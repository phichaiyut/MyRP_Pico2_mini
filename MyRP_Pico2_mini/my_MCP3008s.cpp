...
bool my_MCP3008s::begin(uint8_t cs, SPIClass* theSPI) {
  hwSPI = true;
...
int my_MCP3008s::readADCDifference(uint8_t differential) {
...
int my_MCP3008s::SPIxADC(uint8_t channel, bool differential) {
